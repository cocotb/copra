...
def generate_cpu_stubs():
    ...
    try:
        ...
        print("✓ Generated Markdown documentation: cpu_top_interface.md")
        ...
        print("✓ Generated HTML documentation: cpu_top_interface.html")
        ...
        print("✓ Generated RST documentation: cpu_top_interface.rst")
        ...
        print("✓ Generated testbench template: test_cpu_generated.py")
