...
class TestNamingPatternDetection:
    ...
    def test_detect_clock_patterns(self):
        ...
        signal_names = [
            "clk", "clock", "clk_div", "sys_clk", "pci_clk",
            "data", "reset", "enable"
        ]
    ...
    def test_detect_reset_patterns(self):
        ...
        signal_names = [
            "rst", "reset", "rst_n", "reset_sync", "sys_reset",
            "clk", "data", "enable"
        ]
    ...
    def test_detect_direction_patterns(self):
        ...
        signal_names = [
            "data_in", "data_out", "valid_in", "valid_out",
            "input_ready", "output_valid", "clk", "reset"
        ]
    ...
    def test_detect_bus_patterns(self):
        ...
        signal_names = [
            ...
            "ahb_haddr", "ahb_hwrite", "ahb_hrdata",
            "pci_req", "pci_gnt", "single_signal"
        ]
...
class TestSignalGroupingSuggestions:
    ...
    def test_suggest_groupings_by_prefix(self):
        ...
        signal_names = [
            "cpu_clk", "cpu_rst", "cpu_enable",
            "mem_addr", "mem_data", "mem_we",
            "bus_req", "bus_ack", "bus_data",
            "single_signal"
        ]
    ...
    def test_suggest_groupings_by_function(self):
        ...
        signal_names = [
            "clk1", "clk2", "sys_clk",
            "rst_n", "reset_sync", "por_reset",
            "data_in", "data_out", "addr_in",
            "irq0", "irq1", "irq2"
        ]
