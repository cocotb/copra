...
class TestDUTDiscoverySimulation(unittest.TestCase):
    ...
    def test_discover_dut_from_sources_success(self, mock_mkdtemp, mock_get_runner):
        ...
        with patch.object(self.sim, '_create_discovery_test') as mock_create_test, \
             patch.object(self.sim, '_load_discovered_dut', return_value=mock_dut) as mock_load:
...
class TestSimulationIntegration(unittest.TestCase):
    ...
    def test_simulator_detector_singleton_behavior(self):
        ...
        self.assertEqual(
            detector1.SUPPORTED_SIMULATORS.keys(),
            detector2.SUPPORTED_SIMULATORS.keys()
        )
